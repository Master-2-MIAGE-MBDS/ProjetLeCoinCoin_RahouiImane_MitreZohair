            ...
            >
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <a class="navbar-nav flex-row align-items-center ms-auto" href="${createLink(action: 'index', controller:'login')}">
                            <i class="menu-icon tf-icons bx bx-log-in"></i>
                            <div data-i18n="Analytics">LogIn</div>
                        </a>
                        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a class="navbar-nav flex-row align-items-center ms-auto" href="${createLink(action: 'index', controller:'logout')}">
